    ...
    <div className="flex flex-col gap-10 overflow-x-hidden ">
      <motion.section
        ...
        <motion.div
          ...
          <motion.div className="w-40 aspect-square bg-gray-50/20 rounded-xl">
            <motion.div
              ...
              style={{ scaleY: completionProgress }}></motion.div>
          </motion.div>
        </motion.div>
        <motion.div
          variants={gridSquareVariants}
        ...
        <motion.div
          ...
          <p className="text-xl text-white">Bouncing button</p>
          <motion.button
            whileTap={{ scale: 0.9 }}
            whileHover={{ scale: 1.1, backgroundColor: "#fff", color: "#000" }}
            transition={{ bounceDamping: 10, bounceStiffness: 600 }}
            className="bg-emerald-400 w-1/2 py-4 rounded-lg text-2xl font-light tracking-wide text-white  ">
            Subscribe
          </motion.button>
        </motion.div>
        <motion.div
      ...
      <section className="flex flex-col gap-10 mb-10" ref={containerRef}>
        ...
        <motion.p
          ...
          quaerat minus maiores mollitia nam tenetur voluptatum. Molestias
          natus,
        </motion.p>
        <motion.p
          style={{ translateX: paragraphTwoValue }}
          className="text-slate-100 font-thin text-4xl w-1/2 mx-auto">
          Libero officiis, recusandae officia magnam id nisi in praesentium
          earum dolorum minima veniam, laudantium eius amet repellat doloribus
        </motion.p>
      </section>
    </div>
  );
